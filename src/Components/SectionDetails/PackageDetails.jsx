      ...
      },
      {
        ...
        icon: (
          <>
            ...
            >
              <path
                d="M29.6661 8.43193V21.2053C29.6661 24.8853 26.6794 27.8719 22.9994 27.8719H9.66611C9.05278 27.8719 8.46611 27.7919 7.89278 27.6319C7.06611 27.4053 6.79944 26.3519 7.41278 25.7386L21.5861 11.5653C21.8794 11.2719 22.3194 11.2053 22.7328 11.2853C23.1594 11.3653 23.6261 11.2453 23.9594 10.9253L27.3861 7.48527C28.6394 6.23193 29.6661 6.64527 29.6661 8.43193Z"
                fill="#FF2661"
              ></path>
              <path
                d="M19.8533 10.632L5.89333 24.592C5.25333 25.232 4.18667 25.072 3.76 24.272C3.26667 23.3653 3 22.312 3 21.2053V8.43196C3 6.6453 4.02667 6.23196 5.28 7.4853L8.72 10.9386C9.24 11.4453 10.0933 11.4453 10.6133 10.9386L15.3867 6.15196C15.9067 5.63196 16.76 5.63196 17.28 6.15196L19.8667 8.73863C20.3733 9.25863 20.3733 10.112 19.8533 10.632Z"
                fill="#3d8bfd"
              ></path>
            </svg>
          </>
    ...
    rows: [
      ...
      },
      {
        data: [
          {
            icon: true,
            text: "Manuscript formatting as per target journal guidelines – 1 round",
          },
          {
            icon: true,
            text: "Manuscript formatting as per target journal guidelines – 1 round",
      ...
      },
      {
        data: [
          {
            icon: true,
            text: "Sentence-level editing for pre- and post-journal submission at an affordable rate.",
          },
...

      {
        data: [
          ...
          {
            icon: true,
            text: "Re-editing or proofreading for 365 days or lifetime support for same paper",
          },
          {
            icon: true,
            text: "Re-editing or proofreading for 365 days or lifetime support for same paper",
      ...
      },
      {
        data: [
          ...
          {
            icon: true,
            text: "Plagiarism check using Turnitin; reduction of plagiarism in your manuscript depends on the plagiarism percentage",
          },
          {
            icon: true,
            text: "Plagiarism check using Turnitin; reduction of plagiarism in your manuscript depends on the plagiarism percentage",
      ...
      },
      {
        data: [
          ...
          {
            icon: true,
            text: "Content level editing tailored to give you the best chance of acceptance in high-impact journals.",
          },
          {
            icon: true,
            text: "Getting your manuscript peer-reviewed by experienced journal reviewers",
          },
        ],
      },

      {
        data: [
          ...
          {
            icon: true,
            text: "Peer review assistance following domain-specific content-level editing, offering expert advice on your manuscript.",
          },
        ],
      },
    ],
    ...
    headers: [
      {
        ...
        description: (
          <>
            {" "}
            Our Full Assist package offers comprehensive support throughout your
            manuscript's journey. From initial editing to final submission, we
            handle every aspect of the publication process, giving you the
      ...
      },
      {
        ...
        description: (
          <>
            {" "}
            The Flexi Saver package offers flexible support, giving you the
            freedom to select the services you need, be it journal selection,
            peer review, or journal submission. This cost- effective option
            ensures that you get expert assistance exactly where it&#39;s
            required.'
          </>
        ),
        button: "Select Exclusive Editing →",
    ...
    headers: [
      {
        ...
        description: (
          <>
            {" "}
            The Custom Editing Package offers tailored solutions to refine your
            writing, ensuring polished, professional, and impactful articles
      ...
      },
      {
        ...
        description: (
          <>
            {" "}
            The Custom Publication Package is designed to meet your unique
            research needs, offering expert guidance for seamless manuscript
            preparation, journal submission, and impactful publication
            strategies.
          </>
        ),
        button: "Select Exclusive Editing →",
    ...
    rows: [
      {
        data: [
          {
            icon: true,
            text: "Unlock your writing’s full potential with our tailor-made editing services, tailored specifically for your needs.",
          },
          {
            icon: true,
            text: "Our customized publication package is crafted to meet your unique needs, ensuring every aspect of the publishing process aligns perfectly with your research goals and vision.",
          },
        ],
      },
      {
        data: [
          {
            icon: true,
            text: "Transform your work into polished perfection with our personalized editing solutions, designed to elevate your writing to the next level.",
          },
          {
            icon: true,
            text: "Benefit from the expertise of our seasoned professionals who offer personalized guidance, from manuscript refinement to distribution strategy.",
          },
        ],
      },
    ],
  ...
  return (
    <Container className="package">
      ...
      <Row className="d-flex justify-content-center ">
        <Col
          className={`${
            activeTab === "premium" || activeTab === "customize"
              ? " col-lg-10"
              : "col-lg-12"
          } `}
        >

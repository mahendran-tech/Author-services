    ...
    cards: [
      ...
      },
      {
        ...
        features: [
          ...
          "Subject-area-specific content level editing",
          "Content level editing tailored to give you the best chance of acceptance in high-impact journals.",
        ],
      },
      {
    ...
    cards: [
      {
        title: "Full assist",
        description:
          "Our Full Assist package offers comprehensive support throughout your manuscript's journey. From initial editing to final submission, we handle every aspect of the publication process, giving you the freedom to focus on your research",
        btnname: "Select Core Editing ",
        features: [
          "Journal selection",
      ...
      },
      {
        title: "Flexi Saver",
        description:
          "The Flexi Saver package offers flexible support, giving you the freedom to select the services you need, be it journal selection, peer review, or journal submission. This cost- effective option ensures that you get expert assistance exactly where it's required.",
        btnname: "Select Core Editing ",
        features: [
          "Journal selection",
          "Plagiarism check",
    ...
    cards: [
      {
        title: "Editing",
        description:
          "The Custom Editing Package offers tailored solutions to refine your writing, ensuring polished, professional, and impactful articles that meet your unique needs.",
        btnname: "Select Core Editing ",
        features: [
          "Unlock your writing’s full potential with our tailor-made editing services, tailored specifically for your needs.",
          "Transform your work into polished perfection with our personalized editing solutions, designed to elevate your writing to the next level.",
        ],
      },
      {
        title: "Publication",
        description:
          "The Custom Publication Package is designed to meet your unique research needs, offering expert guidance for seamless manuscript preparation, journal submission, and impactful publication strategies.",
        btnname: "Select Core Editing ",
        features: [
          "Our customized publication package is crafted to meet your unique needs, ensuring every aspect of the publishing process aligns perfectly with your research goals and vision.",
          "Benefit from the expertise of our seasoned professionals who offer personalized guidance, from manuscript refinement to distribution strategy.",
        ],
      },
    ],
  },
...
const PackageTabs = () => {
  ...
  const tab = packageData[activeTab];
  ...
  return (
    <Container className=" package">
      ...
      <Nav
        variant="tabs"
        className="justify-content-center mb-4 package-details"
        activeKey={activeTab}
      ...
      <Row>
        {tab.cards.map((card, idx) => (
          <Col
            md={
              card.title !== "Full assist" &&
              card.title !== "Flexi Saver" &&
              card.title !== "Editing" &&
            ...
            <Card className="h-100 shadow-sm">
              <Card.Body>
                <h6 className="fw-bold gap-1 package-h6 d-flex align-items-center">
                  {titleIcons[card.title]} {card.title}
                </h6>
                {card.description && (
                  <div
                    className="package-content light_color_text "
                    style={{
                      minHeight:
                        card.title === "Full assist"
                          ? "117px"
                    ...
                    <p className="light_color_text">{card.description}</p>
                  </div>
                )}
                {card.btnname && (
                  <Button className="btn-light" size="sm">
                    {card.btnname} <FaArrowRightLong />
                  </Button>
                )}{" "}
                <div className="mt-3">
                  <ul className="list-unstyled package-ul ps-2">
                    {card.features.map((f, i) => (
                      <li className="h-100" key={i}>
                        {" "}
                        {f}
                      </li>
                    ))}

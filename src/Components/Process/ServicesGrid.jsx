...
const services = [
  ...
  },
  {
    ...
    description:
      "A skilled editor will refine your manuscript to improve clarity and flow, ensuring it's error-free and aligned with your publication goals.",
  },
  {
    icon: "assets/img/icon/youget-5.svg",
    title: "Formatting & Illustration editing",
    description:
      "Our experts will carefully format your manuscript—text, figures, tables, and references—to match your target journal's style and citation rules.",
    btnurl: "/get-quote",
  },
  {
  ...
  },
  {
    ...
    description:
      "We will provide you with a professional editing certificate to share with journals, confirming that your manuscript has been polished to high standards.",
  },
];

const ServicesGrid = ({ btnurl }) => {
  return (
    <section>
      <Container className="">
